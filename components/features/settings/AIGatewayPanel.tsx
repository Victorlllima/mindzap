    ...
    <section className="glass-panel rounded-2xl p-6">
      ...
      <div className="mt-5 space-y-4">
        ...
        <div className="rounded-xl border border-[var(--ds-border-default)] bg-[var(--ds-bg-elevated)] p-4">
          <button
            type="button"
            onClick={() => setShowPrimaryConfig(!showPrimaryConfig)}
          ...
          {showPrimaryConfig && (
            <div className="mt-4 border-t border-[var(--ds-border-subtle)] pt-4 space-y-3">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Buscar modelo principal..."
                  value={primarySearch}
              ...
              {modelsLoading ? (
                ...
                const sorted = [...filtered].sort((a, b) => (a.id === config.primaryModel ? 1 : 0) - (b.id === config.primaryModel ? 1 : 0));
                return (
