...
**MindZap** é uma plataforma completa de automação de WhatsApp que ajuda você a se comunicar com clientes de forma mais inteligente e produtiva.

### Por que escolher MindZap?
...
Este guia vai te levar do zero até ter o MindZap funcionando.
...
1. Acesse o repositório do MindZap
2. Clique no botão **Fork** (canto superior direito)
3. Escolha sua conta pessoal ou organização
4. Aguarde o fork ser criado

> **Pronto quando**: Você ver o repositório `MindZap` na sua conta do GitHub
...
4. Selecione **MindZap** (seu fork)
5. Clique em **Deploy**

> **Aguarde**: O deploy leva cerca de 2-3 minutos

6. Quando terminar, copie a URL do seu projeto (ex: `https://MindZap-abc123.vercel.app`)
...
2. **O wizard tem 5 etapas:**
   ...
   **Etapa 2 - Vercel:**
   ...
   - Dê um nome (ex: "MindZap Installer")
   ...
   **Etapa 5 - Redis:**
   ...
   - Nome: **MindZap** • Região: **São Paulo** (ou mais próxima)
...
O MindZap tem estas áreas principais:
...
O MindZap usa dois serviços do Upstash:
...
A senha do MindZap é a variável `MASTER_PASSWORD` no seu projeto Vercel.

**Passo a passo:**

1. Acesse [vercel.com](https://vercel.com) e abra seu projeto MindZap
...
git clone https://github.com/SEU-USUARIO/MindZap.git
cd MindZap
